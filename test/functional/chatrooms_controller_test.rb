...
class ChatroomsControllerTest < ActionController::TestCase
  ...
  test "should create chatroom" do
    assert_difference('Chatroom.count') do
      post :create, chatroom: { is_available: @chatroom.is_available, name: @chatroom.name, venue_id: @chatroom.venue_id }
    end
  ...
  test "should update chatroom" do
    put :update, id: @chatroom, chatroom: { is_available: @chatroom.is_available, name: @chatroom.name, venue_id: @chatroom.venue_id }
    assert_redirected_to chatroom_path(assigns(:chatroom))
  end
